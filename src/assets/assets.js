...
import verify_email from './verify_email.png'
...
export const testimonialsData = [
    {
        id: 1,
        text: "I've been using bg.remover for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.",
    ...
    {
        id: 2,
        text: "I've been using bg.remover for nearly 6 months, I had a fantastic experience. The quality is top-notch. I recommend others to try this app.",
